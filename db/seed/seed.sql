...
INSERT INTO rules (domain,key,value,source) VALUES
 ...
 ('design','logo_gen','same credential ladder with Gemini image models (gemini-2.5-flash-image/Imagen); no key -> universal fill-in prompt for any platform; marks obey design-law (flat, hairline, one accent, 16px-crisp, light+dark variants)','core'),
